...
|--------------------------------------------------------------------------
|
| HTML macros are going in start.php because it's loaded on every page request
|
*/
HTML::macro('html_link', function($url, $text, $attributes = array(), $https = null)
    {
        $url = URL::to($url, $https);

        return '<a href="'.$url.'"'.HTML::attributes($attributes).'>'.$text.'</a>';
    });